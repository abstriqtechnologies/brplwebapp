    ...
    return (
        <CmsForm
            ...
            fields={[
                ...
                { name: "heroImage", label: "Hero Image URL", type: "url", image: true },
                { name: "heroVideoUrl", label: "Hero Video URL", type: "url", image: true, imageKind: "video" },
                ...
                { name: "logoUrl", label: "Logo URL", type: "text", placeholder: "/logo.webp", image: true },
                { name: "footerLogoUrl", label: "Footer Logo URL", type: "text", image: true },
                { name: "faviconUrl", label: "Favicon URL", type: "text", placeholder: "/favicon.ico", image: true },
                { name: "appleTouchIconUrl", label: "Apple Touch Icon URL", type: "text", image: true },
                { name: "ogImage", label: "Default OG Image URL", type: "text", image: true },
