...
/**
 * Route-level error boundary for the public marketing site (`(main)` group).
 * Catches errors thrown by server components or client components in this
 * segment. The root `global-error.tsx` catches anything that escapes.
 */
