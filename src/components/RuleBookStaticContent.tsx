/**
 * Static fallback content for the Rule Book page.
 *
 * Used when the CMS-driven `LegalPage.rulebook.content` is empty. The 700+
 * lines of inline JSX were extracted from `rule-book/page.tsx` in Phase 3.8
 * so the page file stays small and the content is easier to find / translate.
 *
 * The content is verbatim from the original — no copy was rewritten.
 */
